...
const QString JSONShape::keyText = "TextString";
const QString JSONShape::keyTxtPtSize = "TextPointSize";
const QString JSONShape::keyTxtFont = "TextFontFamily";
const QString JSONShape::keyTxtWeight = "TextFontWeight";
